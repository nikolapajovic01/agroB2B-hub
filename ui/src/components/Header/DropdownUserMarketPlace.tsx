    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs">PIB: {companyDetails?.pibNumber || 'Loading...'}</span>
        </span>

        <span className="h-12 w-12 rounded-full flex items-center justify-center overflow-hidden">
          <img src={companyDetails?.photoUrl || UserOne} alt="User" className="w-full h-full object-cover" />
        </span>
